...
<li>
<a <?php if ($_SERVER['PHP_SELF'] == '/recommand.php' || $_SERVER['PHP_SELF'] == '/lost.php' || $_SERVER['PHP_SELF'] == '/articles.php' || $_SERVER['PHP_SELF'] == '/info.php') echo 'class="active"'; ?> title="מידע שימושי" href="javascript:void(0);">מידע שימושי</a>
<nav>
<div>
<ul>
