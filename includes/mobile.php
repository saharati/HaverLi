...
<li class="firstLevel">
<a <?php if ($_SERVER['PHP_SELF'] == '/recommand.php' || $_SERVER['PHP_SELF'] == '/lost.php' || $_SERVER['PHP_SELF'] == '/articles.php' || $_SERVER['PHP_SELF'] == '/info.php' || $_SERVER['PHP_SELF'] == '/article.php') echo 'class="active"'; ?> title="מידע שימושי" href="javascript:void(0);" onclick="toggleView(this.parentNode);">מידע שימושי</a>
<ul>
