...
if (isset($_POST['name'], $_POST['text'], $_FILES['image']))
{
	...
	if (empty($validation))
	{
		$result = $mysqli->query('SELECT MAX(imageOrder) imageOrder FROM recommand');
		...
		else
		{
			...
			$stmt = $mysqli->prepare('INSERT INTO recommand VALUES (?, ?, ?, ?)');
...
<div id="content">
<div id="contentInner">
<form action="/private/addrecommands.php" method="post" enctype="multipart/form-data">
<fieldset>
<h3>הוספת מומלצים</h3>
